...
public class TelaPrincipalEsul extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BtnMelhoria = new javax.swing.JButton();
        ...
        BtnMelhoria.setText("Melhoria(s)");
        BtnMelhoria.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnMelhoriaActionPerformed(evt);
            }
        });
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            String userInput = CaixaTexto.getText(); // Captura a entrada do usuário
            String aiResponse = t.resposta.getText(); // Captura a resposta da IA
            String respostaLimpa = aiResponse.replaceAll("<[^>]*>", "");
            
            

            // Chama o método de salvamento no banco
            BD.saveInteraction(userInput, respostaLimpa);  // Salva no banco
            }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
         ...
         try {
            ...
            String userInputmel = CaixaTexto.getText(); // Captura a entrada do usuário
            String aiResponsemel = telaResposta.resposta.getText(); // Captura a resposta da IA
            String respostaLimpa = aiResponsemel.replaceAll("<[^>]*>", "");
            
            

            // Chama o método de salvamento no banco
            BD.saveInteractionI(userInputmel, respostaLimpa);  // Salva no banco
             }
         } catch (Exception ex) {
             Logger.getLogger(TelaPrincipalEsul.class.getName()).log(Level.SEVERE, null, ex);
         }
    ...
    private void BtnTesteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTesteActionPerformed
        TelaHistTeste telaHist = new TelaHistTeste();
        telaHist.setVisible(true);
        telaHist.setLocationRelativeTo(null); // Centraliza na tela

    }//GEN-LAST:event_BtnTesteActionPerformed

    private void BtnMelhoriaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnMelhoriaActionPerformed
        TelaHistMelhoria telaHist = new TelaHistMelhoria();
        telaHist.setVisible(true);
        telaHist.setLocationRelativeTo(null); // Centraliza na tela
    }//GEN-LAST:event_BtnMelhoriaActionPerformed
    ...
    private javax.swing.JButton BtnMelhoria;
