...
DROP TABLE IF EXISTS `notas_servicos`;
...
--
-- Dumping data for table `notas_servicos`
--

LOCK TABLES `notas_servicos` WRITE;
/*!40000 ALTER TABLE `notas_servicos` DISABLE KEYS */;
INSERT INTO `notas_servicos` VALUES (1232342,'2025-01-26',344343.34,'dsfsfsdfs','sdzfsdfsdfsdfsdf');
